...
public class CallReceiver extends BroadcastReceiver {
    ...
    private void sendLocationSMS(Context context, String phoneNumber, double latitude, double longitude) {
        ...
        // Terminar la llamada entrante
        endIncomingCall(context);
        // Realizar llamada al número marcado
        makeCall(context, phoneNumber);
    }

    private void endIncomingCall(Context context) {
        ...
        try {
            ...
            Log.d("CallReceiver", "Llamada entrante terminada");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void makeCall(Context context, String phoneNumber) {
        ...
        if (context.checkSelfPermission(Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED) {
            ...
            Log.d("CallReceiver", "Realizando llamada a: " + phoneNumber);
        }
    }
}
